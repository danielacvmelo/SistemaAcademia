...
-- O hash usado é: $2a$10$EK8PiphlOm/XMJvyKkehM.ek3QxW61OKcdC7V2DqcMIDxaBMgKy8y
...
INSERT INTO usuarios (id, nome, email, senha, cpf, perfil, criado_em, atualizado_em) VALUES
    (gen_random_uuid(), 'Arnold Schwarzenegger', 'arnold@gym.com', '$2a$10$EK8PiphlOm/XMJvyKkehM.ek3QxW61OKcdC7V2DqcMIDxaBMgKy8y', '11122233301', 'ADMIN', NOW(), NOW());
...
-- Sheila
INSERT INTO usuarios (id, nome, email, senha, cpf, perfil, criado_em, atualizado_em) VALUES
    (gen_random_uuid(), 'Sheila Zen', 'sheila@gym.com', '$2a$10$EK8PiphlOm/XMJvyKkehM.ek3QxW61OKcdC7V2DqcMIDxaBMgKy8y', '11122233302', 'USER', NOW(), NOW());
...
-- Ronnie
INSERT INTO usuarios (id, nome, email, senha, cpf, perfil, criado_em, atualizado_em) VALUES
    (gen_random_uuid(), 'Ronnie Coleman', 'ronnie@gym.com', '$2a$10$EK8PiphlOm/XMJvyKkehM.ek3QxW61OKcdC7V2DqcMIDxaBMgKy8y', '11122233303', 'USER', NOW(), NOW());
...
-- Ana
INSERT INTO usuarios (id, nome, email, senha, cpf, perfil, criado_em, atualizado_em) VALUES
    (gen_random_uuid(), 'Ana Silva', 'ana.silva@email.com', '$2a$10$EK8PiphlOm/XMJvyKkehM.ek3QxW61OKcdC7V2DqcMIDxaBMgKy8y', '00000000001', 'USER', NOW(), NOW());
...
-- Bruno
INSERT INTO usuarios (id, nome, email, senha, cpf, perfil, criado_em, atualizado_em) VALUES
    (gen_random_uuid(), 'Bruno Souza', 'bruno.souza@email.com', '$2a$10$EK8PiphlOm/XMJvyKkehM.ek3QxW61OKcdC7V2DqcMIDxaBMgKy8y', '00000000002', 'USER', NOW(), NOW());
INSERT INTO membros (id, usuario_id, plano_id, data_matricula, status) VALUES
...
-- Carla
INSERT INTO usuarios (id, nome, email, senha, cpf, perfil, criado_em, atualizado_em) VALUES
    (gen_random_uuid(), 'Carla Diaz', 'carla.diaz@email.com', '$2a$10$EK8PiphlOm/XMJvyKkehM.ek3QxW61OKcdC7V2DqcMIDxaBMgKy8y', '00000000003', 'USER', NOW(), NOW());
INSERT INTO membros (id, usuario_id, plano_id, data_matricula, status) VALUES
...
-- Daniel
INSERT INTO usuarios (id, nome, email, senha, cpf, perfil, criado_em, atualizado_em) VALUES
    (gen_random_uuid(), 'Daniel Oliveira', 'daniel.o@email.com', '$2a$10$EK8PiphlOm/XMJvyKkehM.ek3QxW61OKcdC7V2DqcMIDxaBMgKy8y', '00000000004', 'USER', NOW(), NOW());
INSERT INTO membros (id, usuario_id, plano_id, data_matricula, status) VALUES
...
-- Eduardo
INSERT INTO usuarios (id, nome, email, senha, cpf, perfil, criado_em, atualizado_em) VALUES
    (gen_random_uuid(), 'Eduardo Lima', 'edu.lima@email.com', '$2a$10$EK8PiphlOm/XMJvyKkehM.ek3QxW61OKcdC7V2DqcMIDxaBMgKy8y', '00000000005', 'USER', NOW(), NOW());
INSERT INTO membros (id, usuario_id, plano_id, data_matricula, status) VALUES
...
-- Fernanda
INSERT INTO usuarios (id, nome, email, senha, cpf, perfil, criado_em, atualizado_em) VALUES
    (gen_random_uuid(), 'Fernanda Costa', 'nanda@email.com', '$2a$10$EK8PiphlOm/XMJvyKkehM.ek3QxW61OKcdC7V2DqcMIDxaBMgKy8y', '00000000006', 'USER', NOW(), NOW());
INSERT INTO membros (id, usuario_id, plano_id, data_matricula, status) VALUES
...
-- Gabriel
INSERT INTO usuarios (id, nome, email, senha, cpf, perfil, criado_em, atualizado_em) VALUES
    (gen_random_uuid(), 'Gabriel Medina', 'gabs@email.com', '$2a$10$EK8PiphlOm/XMJvyKkehM.ek3QxW61OKcdC7V2DqcMIDxaBMgKy8y', '00000000007', 'USER', NOW(), NOW());
INSERT INTO membros (id, usuario_id, plano_id, data_matricula, status) VALUES
    (gen_random_uuid(), (SELECT id FROM usuarios WHERE email='gabs@email.com'), '22222222-2222-2222-2222-222222222222', '2025-02-01', 'ATIVO');

-- Hugo
INSERT INTO usuarios (id, nome, email, senha, cpf, perfil, criado_em, atualizado_em) VALUES
    (gen_random_uuid(), 'Hugo Gloss', 'hugo@email.com', '$2a$10$EK8PiphlOm/XMJvyKkehM.ek3QxW61OKcdC7V2DqcMIDxaBMgKy8y', '00000000008', 'USER', NOW(), NOW());
INSERT INTO membros (id, usuario_id, plano_id, data_matricula, status) VALUES
    (gen_random_uuid(), (SELECT id FROM usuarios WHERE email='hugo@email.com'), '33333333-3333-3333-3333-333333333333', '2025-02-02', 'ATIVO');

-- Igor
INSERT INTO usuarios (id, nome, email, senha, cpf, perfil, criado_em, atualizado_em) VALUES
    (gen_random_uuid(), 'Igor 3K', 'igor@email.com', '$2a$10$EK8PiphlOm/XMJvyKkehM.ek3QxW61OKcdC7V2DqcMIDxaBMgKy8y', '00000000009', 'USER', NOW(), NOW());
INSERT INTO membros (id, usuario_id, plano_id, data_matricula, status) VALUES
    (gen_random_uuid(), (SELECT id FROM usuarios WHERE email='igor@email.com'), '11111111-1111-1111-1111-111111111111', '2025-02-03', 'ATIVO');

-- Joana
INSERT INTO usuarios (id, nome, email, senha, cpf, perfil, criado_em, atualizado_em) VALUES
    (gen_random_uuid(), 'Joana Dark', 'joana@email.com', '$2a$10$EK8PiphlOm/XMJvyKkehM.ek3QxW61OKcdC7V2DqcMIDxaBMgKy8y', '00000000010', 'USER', NOW(), NOW());
INSERT INTO membros (id, usuario_id, plano_id, data_matricula, status) VALUES
...
-- Kleber
INSERT INTO usuarios (id, nome, email, senha, cpf, perfil, criado_em, atualizado_em) VALUES
    (gen_random_uuid(), 'Kleber Bambam', 'kleber@email.com', '$2a$10$EK8PiphlOm/XMJvyKkehM.ek3QxW61OKcdC7V2DqcMIDxaBMgKy8y', '00000000011', 'USER', NOW(), NOW());
INSERT INTO membros (id, usuario_id, plano_id, data_matricula, status) VALUES
...
-- Luisa
INSERT INTO usuarios (id, nome, email, senha, cpf, perfil, criado_em, atualizado_em) VALUES
    (gen_random_uuid(), 'Luisa Sonza', 'luisa@email.com', '$2a$10$EK8PiphlOm/XMJvyKkehM.ek3QxW61OKcdC7V2DqcMIDxaBMgKy8y', '00000000012', 'USER', NOW(), NOW());
INSERT INTO membros (id, usuario_id, plano_id, data_matricula, status) VALUES
...
-- Marcos
INSERT INTO usuarios (id, nome, email, senha, cpf, perfil, criado_em, atualizado_em) VALUES
    (gen_random_uuid(), 'Marcos Mion', 'mion@email.com', '$2a$10$EK8PiphlOm/XMJvyKkehM.ek3QxW61OKcdC7V2DqcMIDxaBMgKy8y', '00000000013', 'USER', NOW(), NOW());
INSERT INTO membros (id, usuario_id, plano_id, data_matricula, status) VALUES
    (gen_random_uuid(), (SELECT id FROM usuarios WHERE email='mion@email.com'), '11111111-1111-1111-1111-111111111111', '2025-03-03', 'ATIVO');

-- Neymar
INSERT INTO usuarios (id, nome, email, senha, cpf, perfil, criado_em, atualizado_em) VALUES
    (gen_random_uuid(), 'Neymar Junior', 'neymar@email.com', '$2a$10$EK8PiphlOm/XMJvyKkehM.ek3QxW61OKcdC7V2DqcMIDxaBMgKy8y', '00000000014', 'USER', NOW(), NOW());
INSERT INTO membros (id, usuario_id, plano_id, data_matricula, status) VALUES
...
-- Oscar
INSERT INTO usuarios (id, nome, email, senha, cpf, perfil, criado_em, atualizado_em) VALUES
    (gen_random_uuid(), 'Oscar Schmidt', 'oscar@email.com', '$2a$10$EK8PiphlOm/XMJvyKkehM.ek3QxW61OKcdC7V2DqcMIDxaBMgKy8y', '00000000015', 'USER', NOW(), NOW());
INSERT INTO membros (id, usuario_id, plano_id, data_matricula, status) VALUES
